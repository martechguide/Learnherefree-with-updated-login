...
export default function AdminDashboard() {
  ...
  const handleEditPlatformVideo = (video: MultiPlatformVideo) => {
    try {
      console.log('Edit platform video clicked:', video.id, video.title);
      ...
      console.error('Error in handleEditPlatformVideo:', error);
      toast({
        title: "Error",
  ...
  const handleDeletePlatformVideo = (videoId: string) => {
    try {
      console.log('Delete platform video clicked:', videoId);
      ...
      console.error('Error in handleDeletePlatformVideo:', error);
      toast({
        title: "Error",
        description: "Failed to delete video",
        variant: "destructive",
