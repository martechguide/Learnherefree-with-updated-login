...
export const users = pgTable("users", {
  ...
  phone: varchar("phone").unique(), // phone number for SMS OTP
...
export const passwordResetTokens = pgTable("password_reset_tokens", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  email: varchar("email"), // can be null for phone-based reset
  phone: varchar("phone"), // can be null for email-based reset  
